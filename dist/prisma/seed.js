    ...
    return [
        {
            ...
            description: '<p>The Hohner Fun Top button accordion was made in Italy. The Fun Top series was developed for stage use. It is a very stable, reliable and above all powerful instrument. The Hohner Fun Top was equipped with the Amplisound. </p> <p>The treble was equipped with 4 choirs. The sound of the treble can be changed via 5 registers. The treble register switches were placed on the back of the instrument. This allows for quick switching during play. The bass has 120 bass buttons and 5 bass registers. The sound production was realized by Tipo A Mano reedplates.</p><p>The Hohner Fun Top comes with a new Hohner backpack and new Hohner straps.</p>',
        ...
        },
        {
            ...
            description: '<p>The used Hohner Amati C-system button accordion is in a very good condition. It was made in Germany.</p><p>The treble was equipped with 3 choirs and 62 buttons. The 3 choirs can be switched via 5 treble registers. The bass was equipped with 96 bass buttons.</p><p> The Hohner Amati button accordion comes with a new backpack and new straps (made in Italy).</p><p>Each used button accordion is completely overhauled in our workshop.</p>',
        ...
        },
        {
            ...
            description: '<p>The  Hohner Morino V S accordion is in excellent condition. The 120 bass accordion was made in Germany.</p><p>The treble was equipped with 5 choirs. The sound of the treble can be changed via 14 treble stops. The Hohner Morino VS has Musette tuning and a Cassotto shaft (in the treble). In addition, the Hohner Morino was equipped with piccolo voices. The bass has 120 bass buttons and 5 bass stops. The bass stops switch the 5 choirs of the 120 standard basses.</p><p>This beautiful Hohner Morino accordion comes with a used case and new accordion straps (made in Italy).</p><p>Every  accordion is completely overhauled and tuned in our professional workshop.</p>',
        ...
        },
        {
            ...
            description: '<p>The 120 Bass Cavagnolo B-grip button accordion is in very good condition. It was made in France.</p><p>The treble was equipped with 4 choirs (4 8 16). In addition, it was equipped with a cassotto shaft. The 4 and the 16 foot are in the cassotto. The bass has 5 choirs and 120 bass buttons.</p><p>The Cavagnolo B-grip button accordion comes with a new backpack (made in Italy) and new straps (made in Italy).</p><p>Each used button accordion is completely overhauled in our workshop.</p>',
...
async function seed() {
    ...
    await Promise.all(getImages().map((_a) => {
        var { productId } = _a, imageData = __rest(_a, ["productId"]);
        return db.image.create({
            data: Object.assign(Object.assign({}, imageData), { product: {
